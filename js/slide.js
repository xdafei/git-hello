...
(function(window) {
 ...
 var pages=document.getElementsByClassName("wp-inner")[0];
        var myul=document.getElementById("myul");
        var pageDiv=pages.getElementsByTagName("div");
        var b=''  ;
    ...
    var start=document.getElementById("start"); 
        ...
        document.getElementsByClassName('wp-inner')[0].fullpage({
            change: function (e) {
                ...
                var liEles = document.getElementsByClassName("indicator")[0].getElementsByTagName("li");
                for (var i = 0; i < liEles.length; i++) {
                    var liEle = liEles[i];
                    if(i === e.cur){
                        liEle.classList.add("cur");
                    }else{
                        liEle.classList.remove("cur");
                    }
                }
            },
            beforeChange: function (e) {
                console.log('beforeChange', e.next, e.cur);
                 if(e.next==(pageDiv.length-1)){
